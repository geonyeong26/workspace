 ...
 * - 문자열을 주소로 바꾸면 포인터 연산을 통해 시작위치부터 길이 제한 없이 사용 가능
 ...
 * ex) *"apple" = 't'; 코드상으로 문제 없지만 실행하면 "강제종료"될 수 있음음
 * 
 ...
 *      - String(문자열), Tuple, ...
 * → C언어는 절차지향언어이기 때문에 위의 Types를 사용하지는 않지만, C언어의 문자열은 Immutable Types와 비슷하다고 생각하면 쉬움
 * 
 */
